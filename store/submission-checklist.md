...
- [ ] Manual simulator pass: set anchor → move outside → alarm → silence (mute icon + ring, display stays on) → adjust radius / end → verify 60 s snooze; idle dim @30s / off @40s; tap wakes
