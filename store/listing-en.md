...
6. From the alarm screen you can silence for 60 seconds, enlarge the radius with UP/DOWN, or open the menu to stop or continue surveillance.
7. Choose **Stop surveillance** from the on-watch menu when you are done (or **Continue surveillance** to keep monitoring).
...
- Silence for 60 s, adjust radius, or stop/continue surveillance from the alarm menu
- Stop surveillance from the watch menu when finished
